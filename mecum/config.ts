...
export const OUTPUT_DIR = String(process.env.OUTPUT_DIR ?? path.join(process.cwd(), "fetchedData", 'prices'));
...
export const BASE_URLS: string[] = [
    ...
    // 'https://www.mecum.com/auctions/kissimmee-2023/lots/?auction[0]=Kissimmee+2023|1672790400|1673740800&configure[filters]=&configure[ruleContexts][0]=pin_items&sortBy=wp_posts_lot_sort_order_asc&type[0]=Auto&year=1968:1968&make[0]=Volkswagen&saleResult[0]=sold&page='
    ...
    'https://www.mecum.com/auctions/orlando-2021/lots/?auction[0]=Orlando+Summer+Special+2021|1627430400|1627689600&configure[filters]=&configure[ruleContexts][0]=pin_items&sortBy=wp_posts_lot_sort_order_asc&type[0]=Auto&page='
];
